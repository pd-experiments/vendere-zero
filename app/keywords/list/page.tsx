...
export default function KeywordsList() {
  ...
  const onBatchGenerate = async (
    values: z.infer<typeof batchGenerationSchema>
  ) => {
    ...
    try {
      ...
      toast.success(
        `Batch generation completed: Generated ${result.variants_generated} variants for ${result.successful} keywords. ${result.failed} keywords failed.`
      );

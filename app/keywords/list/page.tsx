            ...
            if (taskData.status === "completed") {
              toast.success(
                `Task completed: Generated ${
                  taskData.result?.variants_generated || 0
                } variants`
              );
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground">
              Manage your research items and generate keyword variants
            </p>
          </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <div className="flex flex-col gap-2">
                <CardTitle>Research Items List</CardTitle>
                <CardDescription>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <RefreshCw className="mr-2 h-4 w-4" /> Batch Generate
                </Button>
              </div>
            </CardHeader>
            <CardContent>
                                  ...
                                  <div className="flex items-center">
                                    ...
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Badge
                                          variant="outline"
                                          className="bg-gradient-to-r from-blue-100 to-indigo-200 text-indigo-800 border-indigo-300 font-medium hover:from-blue-200 hover:to-indigo-300 transition-all cursor-pointer"
                                          onClick={() =>
                                    ...
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Button
                                          variant="ghost"
                                          size="sm"
                                          className="h-6 px-2 text-xs flex items-center gap-1 text-emerald-700 hover:text-emerald-900 hover:bg-emerald-50"
                                              ...
                                              (variant, variantIndex) => (
                                                ...
                                                >
                                                  ...
                                                  <TableCell>
                                                    <div className="flex gap-2">
                                                      <div className="flex flex-col items-center">
                                                        ...
                                                        <div
                                                          className={`h-6 w-6 rounded-full flex items-center justify-center text-xs font-medium ${getMetricColor(
                                                  ...
                                                  <TableCell>
                                                    <div className="flex items-center gap-2">
                                                      <div
                                                        className={`h-8 min-w-[3rem] rounded-md px-2 flex items-center justify-center font-medium ${getMetricColor(
